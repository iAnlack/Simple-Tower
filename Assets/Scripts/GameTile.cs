...
public class GameTile : MonoBehaviour
{
    ...
    private GameTile _north, _west, _south, _east, _nextOnPath;
    ...
    private Quaternion _westRotation = Quaternion.Euler(90f, 270f, 0f);          // если ошибка в итоге будет здесь, это трындец.
